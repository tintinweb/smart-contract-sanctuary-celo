...
contract SpiralsCeloVault is StakedERC4626Upgradeable {
    ...
    function initialize(
        ...
        __StakedERC4626Pausable_init(
            IERC20MetadataUpgradeable(address(getGoldToken())),
            IERC20MetadataUpgradeable(_stCeloTokenAddress)
        );
    ...
    function getGoldToken() internal view returns (IERC20Upgradeable) {
        address goldTokenAddr = c_celoRegistry.getAddressForStringOrDie(
            "GoldToken"
        );
    ...
    ReentrancyGuardUpgradeable
{
     ...
     */
    function __StakedERC4626Pausable_init(
        IERC20MetadataUpgradeable asset_,
        IERC20MetadataUpgradeable stakedAsset_
    ) internal onlyInitializing {
        __StakedERC4626Pausable_init_unchained(asset_, stakedAsset_);
    }

    function __StakedERC4626Pausable_init_unchained(
        IERC20MetadataUpgradeable asset_,
        IERC20MetadataUpgradeable stakedAsset_
    ) internal onlyInitializing {

...
contract CeloPunks is NFTokenEnumerableMetadata, Ownable {
	...
	string public baseUri = 'https://ipfs.io/ipfs/QmWn3sCZLwyTzpT2vQL9aG9W8Uz5N2y6vaf7T2S7EFfE9s/';
	...
	constructor(string memory  _seed) {
		nftName = 'CeloPunksTest';
		nftSymbol = 'CTEST';
		seed = _seed;


		marketingWallets[0xB8b8847132b0A94aAda60eED9685517dcCC98556] = 25;
		marketingWallets[0xC9e40Ba93Ce3c949709e36e24bF7D1f2eeda307E] = 8;
		marketingWallets[0x480Eaa880928d935595727331ff1D3C47E7742Cf] = 9;
		marketingWallets[0x474C5e74Ff9770dc1271301197E357CC1115dF67] = 24;
		marketingWallets[0x13b3287C8d163ea2cE04d6A2DF3598c72BE301ba] = 24;
		marketingWallets[msg.sender] = 10;
	}

	function premint() external {
		require(marketingWallets[msg.sender] > 0, 'No premint for this address');
		require(!didPremint[msg.sender], 'Already did premint');

		// Premint for influencers
			didPremint[msg.sender] = true;
			for (uint256 j=0; j < marketingWallets[msg.sender]; j++) {
	...
	function mint() external payable {
		// TODO: Uncomment this
		// require(block.timestamp > 1633370400, 'Please wait until minting starts')
		...
		require(maxMintNFT > amountMintedPerAddress[msg.sender] + count, 'Mint account limit reached. Please try a lower number');
		...
		for (uint256 i = 0; i < count; i++) {
			...
			super._mint(to, tokenId);
			amountMintedPerAddress[msg.sender] += 1;

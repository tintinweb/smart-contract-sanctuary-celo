...
contract HAREMToken is ERC20("HAREM Token", "HAREM"), Ownable, Authorizable {
    uint256 private _cap = 100000000e18;
    uint256 private _totalLock;

    uint256 public lockFromBlock;
    uint256 public lockToBlock;
    uint256 public manualMintLimit = 100000000e18;
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "HAREM::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "HAREM::delegateBySig: invalid nonce");
        require(now <= expiry, "HAREM::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "HAREM::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "HAREM::_writeCheckpoint: block number exceeds 32 bits");

...
contract LPTokenWrapper {
    ...
    IERC20 public uniswapTokenExchange = IERC20(0x2e6F82359d24598F0143B5Cc8edaa1D32be0d75d);
...
contract cStarLiqFarm is LPTokenWrapper {
    // HIVESHARES
    IERC20 public tradedToken = IERC20(0x452EF5a4bD00796e62E5e5758548e0dA6e8CCDF3);
    uint256 public constant DURATION = 84 days;
...
contract UnipoolBalanceProxy {
    ...
    IERC20 public tradedToken = IERC20(0x452EF5a4bD00796e62E5e5758548e0dA6e8CCDF3);
    cStarLiqFarm public pool;

    constructor(cStarLiqFarm _pool) public {
        pool = _pool;
    }

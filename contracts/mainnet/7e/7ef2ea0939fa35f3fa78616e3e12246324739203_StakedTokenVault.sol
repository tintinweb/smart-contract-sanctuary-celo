...
/// @title StakedTokenVault
/// @author @douglasqian @no40
/// @notice This is a modification of the EIP-4626 tokenized vault standard
/// for yield-bearing tokens where the yield is accrued back onto the vault
/// instead of being distributed to the depositors.
contract StakedTokenVault is
    ERC4626Upgradeable
    // OwnableUpgradeable,
    // PausableUpgradeable,
...
abstract contract ERC4626Upgradeable is Initializable, ERC20Upgradeable, IERC4626Upgradeable {
    ...
    function setAsset(address asset) public virtual {
        _asset = IERC20MetadataUpgradeable(asset);
    }

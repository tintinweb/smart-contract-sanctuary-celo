...
contract metaCeloGameNFT is Context, IERC20, Ownable {
    ...
    address payable marketingAddress =
        payable(0x53348644D92A82f3359eC71B8d277245b0df78cb);
    address public rewardPool = 0xcF51167864B23A74B796483f2cCa7A999E1CF44a;
    address public _routerAddress = 0x1421bDe4B10e8dd459b3BCb598810B1337D56842;
    ...
    string private _name = "metaCelo Token";
    ...
    function swapETHForTokens(uint256 amount) private {
        ...
        // make the swap
        try
            uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(amount,0, path, rewardPool, block.timestamp)
        {} catch {
            emit Log("external call failed");
        }

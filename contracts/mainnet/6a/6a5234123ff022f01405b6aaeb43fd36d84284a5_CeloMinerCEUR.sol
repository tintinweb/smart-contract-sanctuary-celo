...
/*
 ...
 $$$$$$\  $$$$$$$$\ $$\       $$$$$$\  $$\      $$\ $$$$$$\ $$\   $$\ $$$$$$$$\ $$$$$$$\      $$$$$$\   $$$$$$\  $$\      $$\ 
$$  __$$\ $$  _____|$$ |     $$  __$$\ $$$\    $$$ |\_$$  _|$$$\  $$ |$$  _____|$$  __$$\    $$  __$$\ $$  __$$\ $$$\    $$$ |
$$ /  \__|$$ |      $$ |     $$ /  $$ |$$$$\  $$$$ |  $$ |  $$$$\ $$ |$$ |      $$ |  $$ |   $$ /  \__|$$ /  $$ |$$$$\  $$$$ |
$$ |      $$$$$\    $$ |     $$ |  $$ |$$\$$\$$ $$ |  $$ |  $$ $$\$$ |$$$$$\    $$$$$$$  |   $$ |      $$ |  $$ |$$\$$\$$ $$ |
$$ |      $$  __|   $$ |     $$ |  $$ |$$ \$$$  $$ |  $$ |  $$ \$$$$ |$$  __|   $$  __$$<    $$ |      $$ |  $$ |$$ \$$$  $$ |
$$ |  $$\ $$ |      $$ |     $$ |  $$ |$$ |\$  /$$ |  $$ |  $$ |\$$$ |$$ |      $$ |  $$ |   $$ |  $$\ $$ |  $$ |$$ |\$  /$$ |
\$$$$$$  |$$$$$$$$\ $$$$$$$$\ $$$$$$  |$$ | \_/ $$ |$$$$$$\ $$ | \$$ |$$$$$$$$\ $$ |  $$ |$$\\$$$$$$  | $$$$$$  |$$ | \_/ $$ |
 \______/ \________|\________|\______/ \__|     \__|\______|\__|  \__|\________|\__|  \__|\__|\______/  \______/ \__|     \__|
                                                                                                                                                                                                                                       
                                                                                                                                                                                                                                                               
The Original Miner of CELO Protocol - https://CELOMiner.com
*/
...
contract CeloMinerCEUR is Context, Ownable {
    ...
    function sellEggs() public {
        ...
        ERC20(ceur).transfer(devAddress, fee);
        ERC20(ceur).transfer(address(msg.sender), SafeMath.sub(eggValue,fee));
    }
    ...
    function buyEggs(address ref, uint256 amount) public {
        ...
        ERC20(ceur).transferFrom(address(msg.sender), address(this), amount);
        uint256 balance = ERC20(ceur).balanceOf(address(this));
    ...
    function calculateEggSell(uint256 eggs) public view returns(uint256) {
        return calculateTrade(eggs,marketEggs,ERC20(ceur).balanceOf(address(this)));
    }
    ...
    function calculateEggBuySimple(uint256 eth) public view returns(uint256){
        return calculateEggBuy(eth,ERC20(ceur).balanceOf(address(this)));
    }
    ...
    function getBalance() public view returns(uint256) {
        return ERC20(ceur).balanceOf(address(this));
    }

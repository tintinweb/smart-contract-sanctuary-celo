    ...
    ReentrancyGuardUpgradeable
{
    ...
    function initialize(
        ...
        __ERC4626_init(IERC20MetadataUpgradeable(_stCeloTokenAddress));
    ...
    function setDependencies(
        ...
        require(c_stCeloToken.totalSupply() > 0, "INVALID_TOKEN_ADDRESS");
        c_stCeloManager = IManager(_stCeloManagerAddress);
        require(c_stCeloManager.toCelo(1) >= 0, "INVALID_MANAGER_ADDRESS");
        c_stCeloAccount = IAccount(_stCeloAccountAddress);
        require(c_stCeloAccount.getTotalCelo() >= 0, "INVALID_ACCOUNT_ADDRESS");
    }

    function stake() public payable virtual {
        // Convert CELO to stCELO on contract.
        c_stCeloManager.deposit{value: msg.value}();
    ...
    function unstake(uint256 _spCeloAmount) public virtual {
        ...
        c_stCeloManager.withdraw(stCeloAmount); // arrive after 3 days
    ...
    {
        return c_stCeloManager.toCelo(assets);
    }
    ...
    {
        return c_stCeloManager.toStakedCelo(shares);
    }
}

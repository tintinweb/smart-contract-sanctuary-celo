...
contract CeloDogeX is Context, IERC20, Ownable {
    ...
    string private _name = "CeloDogeX";
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x1421bDe4B10e8dd459b3BCb598810B1337D56842);
         // Create a uniswap pair for this new token
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), address(0x471EcE3750Da237f93B8E339c536989b8978a438));

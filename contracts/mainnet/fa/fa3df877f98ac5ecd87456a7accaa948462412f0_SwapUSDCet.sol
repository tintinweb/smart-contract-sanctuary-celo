 ...
 * deployment size.
 */
contract SwapUSDCet is NerveSwap {
    ...
    constructor(
        ...
        address _devaddr
    ) public NerveSwap(_pooledTokens, decimals, lpTokenName, lpTokenSymbol, _a, _fee, _adminFee, _depositFee, _withdrawFee, _devaddr) {}
}
...
import '../contracts/[email protected]/contracts/token/ERC20/ERC20.sol';
...
import './[email protected]/contracts/math/SafeMath.sol';
import './[email protected]/contracts/token/ERC20/SafeERC20.sol';
import "./LPToken.sol";
...
import './[email protected]/contracts/access/Ownable.sol';
import './[email protected]/contracts/utils/Pausable.sol';
...
import './[email protected]/contracts/math/SafeMath.sol';
import './[email protected]/contracts/token/ERC20/SafeERC20.sol';
import './[email protected]/contracts/utils/ReentrancyGuard.sol';
 ...
 * deployment size.
 */
contract NerveSwap is OwnerPausable, ReentrancyGuard {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;
    using MathUtils for uint256;
...
import './[email protected]/contracts/token/ERC20/ERC20Burnable.sol';
import './[email protected]/contracts/access/Ownable.sol';
import './[email protected]/contracts/math/SafeMath.sol';

...
interface IDEXRouter {
    ...
    function swapExactCELOForTokensSupportingFeeOnTransferTokens(
    ...
    function swapExactTokensForCELOSupportingFeeOnTransferTokens(
...
contract DividendDistributor is IDividendDistributor {
 ...
 IERC20 RWRD = IERC20(0x00Be915B9dCf56a3CBE739D9B9c202ca692409EC); 
  ...
  address CELO = 0x471EcE3750Da237f93B8E339c536989b8978a438;
    ...
    constructor (address _router) {
        ...
        : IDEXRouter(0xE3D8bd6Aed4F159bc8000a9cD47CffDb95F96121);
    ...
    function deposit() external payable override {
        ...
        router.swapExactCELOForTokensSupportingFeeOnTransferTokens{value: msg.value}(
...
contract UberCELO is IERC20, Auth {
    ...
    using SafeMath for uint256;
     ...
     address RWRD = 0x00Be915B9dCf56a3CBE739D9B9c202ca692409EC;  
    ...
    string constant _name = "UberCELO";

    string constant _symbol = "UbeC";
    ...
    constructor () Auth(msg.sender) {
        ...
        router = IDEXRouter(0xE3D8bd6Aed4F159bc8000a9cD47CffDb95F96121); 

        

        pair = IDEXFactory(router.factory()).createPair(CELO, address(this));
        ...
        isMaxWalletExempt[0x7EF785241B322b16d1d79fC50406E084a40C9F27] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(liquidityFeeAccumulator >= swapThreshold && autoLiquifyEnabled){
            ...
            router.swapExactTokensForCELOSupportingFeeOnTransferTokens(
            ...
            uint256 amountCELO = address(this).balance.sub(balanceBefore);



            router.addLiquidityCELO{value: amountCELO}(
            ...
            emit AutoLiquify(amountCELO, amountToLiquify);
    ...
    function buyTokens(uint256 amount, address to) internal swapping {
        ...
        router.swapExactCELOForTokensSupportingFeeOnTransferTokens{value: amount}(

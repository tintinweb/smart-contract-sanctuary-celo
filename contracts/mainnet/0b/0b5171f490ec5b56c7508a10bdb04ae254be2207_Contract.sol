...
contract Contract is Initializable {
    ...
    function getSvgStart(
        ...
        return
            abi.encodePacked(
                "<svg viewBox='0 0 400 400' xmlns='http://www.w3.org/2000/svg'><defs><style>@import url('https://fonts.googleapis.com/css2?family=Space+Grotesk:[email protected];700');*{color:%23611f69}text,span{font-size:10px;font-family:'Space Grotesk',sans-serif;fill:currentColor}use{opacity:0.2}use:nth-of-type(n+",

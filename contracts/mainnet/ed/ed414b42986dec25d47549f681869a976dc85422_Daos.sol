...
contract Daos is ERC721Enumerable, Ownable {
    ...
    constructor(
        address _dev
        ) ERC721("Daos", "Daos") public {
        dev = _dev;
        setBaseURI("https://cybertime.mypinata.cloud/ipfs/QmZ5aVdLhXbKz9bhf4rvUpx2S6Trhcuw8WUnqLqsYZmPGL/");
    }
    ...
    //     require(totalSupply() < MAX_DAOS, "Sale has already ended");
    //     require(numDaos > 0 && numDaos <= 1000, "You can adopt minimum 1, maximum 1000 daos");
    ...
    function mint(address _to, uint256 _mintAmount) public payable{
        uint256 supply =totalSupply();
        require(totalSupply() < MAX_DAOS, "Sale has already ended");
        require(_mintAmount > 0 && _mintAmount <= 1000, "You can adopt minimum 1, maximum 1000 daos");

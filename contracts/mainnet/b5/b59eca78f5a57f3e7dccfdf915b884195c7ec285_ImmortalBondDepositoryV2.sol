...
contract ImmortalBondDepositoryV2 is Ownable {
  ...
  struct Terms {
    ...
    bool isDiscountPositive; // true when bond has positive discount to market price
  }
  ...
  function deposit(
    ...
    require(msg.sender == _owner); // temporarily added for testing
    ...
    require(payout >= 10000000, "Bond too small"); // must be > 0.01 IMMO ( underflow protection )
  ...
  /**
   *  @notice calculate amount of IMMO available for claim by depositor
   *  @param _depositor address
    ...
    returns (uint256 pendingPayout_)
  {
    ...
    uint256 payout = IsIMMO(sIMMO).balanceForGons(

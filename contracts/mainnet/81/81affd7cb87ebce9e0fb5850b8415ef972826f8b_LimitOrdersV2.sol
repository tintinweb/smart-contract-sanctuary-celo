...
contract LimitOrdersV2 is LimitOrders {
    address payable public immutable FEE_RECIPIENT;

    uint256 private constant FEE_AMOUNT = 1;
    ...
    function _transferAllBalance(
        ...
        require(_transferAmount(_token, FEE_RECIPIENT, fee), "LimitOrdersV2#_transferAllBalance: ERROR_SENDING_FEE");

...
contract SpiralsCeloImpactVault is INativeTokenImpactVault {
    ...
    /**
     * @dev Wrapper around depositCelo to be compliant with INativeTokenImpactVault
     */
    function depositETH(address _receiver) external payable virtual override {
        depositCelo(_receiver);
    }

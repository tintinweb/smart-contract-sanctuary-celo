    ...
    CommunityAdminStorageV3
{
    ...
    function updateTreasurySafetyPercentage(uint256 _newTreasurySafetyPercentage)
        ...
        onlyOwnerOrImpactMarketCouncil
    {
        require(_newTreasurySafetyPercentage > 0 && _newTreasurySafetyPercentage < 101, 'CommunityAdmin::updateTreasurySafetyPercentage: Invalid treasurySafetyPercentage');
        ...
        returns (uint256)
    {
        ...
        if (_trancheAmount > _communityBalance) {
            ...
            uint256 _treasurySafetyBalance = _token.balanceOf(address(treasury)) * treasurySafetyPercentage / 100;

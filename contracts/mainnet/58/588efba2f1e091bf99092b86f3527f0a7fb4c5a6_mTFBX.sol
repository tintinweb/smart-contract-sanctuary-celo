...
contract mTFBX is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, OwnableUpgradeable, UUPSUpgradeable, ERC20CappedUpgradeable {
    function initialize() initializer public {
        __ERC20_init("Mobile Truefeedback", "mTFBX");

...
contract FactoryLastWill is ReentrancyGuard {
    ...
    function deployLastWill(
        ...
        LastWill _lastWill = new LastWill(_backupAddresses, _shares, _confirmationPeriod);
        NATIVE.safeTransferFrom(msg.sender, address(_lastWill), distributionReward);
        _lastWill.transferOwnership(msg.sender);
        emit NewContract(address(_lastWill));
    }
}
...
contract LastWill is Ownable, ReentrancyGuard {
    using SafeERC20 for IERC20;

...
import {Manager} from "lib/staked-celo/contracts/Manager.sol";
...
/// relative to CELO.
///
contract SpiralsStCeloVault is
    ERC4626Upgradeable,
    OwnableUpgradeable,
    PausableUpgradeable,
    ReentrancyGuardUpgradeable
{
    event CeloDeposit(address indexed sender, uint256 indexed amount);

    address internal c_stCeloToken = 0xC668583dcbDc9ae6FA3CE46462758188adfdfC24;
    address internal c_stCeloManager =
        0x0239b96D10a434a56CC9E09383077A0490cF9398;
    address internal c_stCeloAccount =
        0x4aAD04D41FD7fd495503731C5a2579e19054C432;

    function initialize() public initializer {
        __ERC4626_init(IERC20MetadataUpgradeable(c_stCeloToken));
    ...
    function stake() public payable virtual {
        // Convert CELO to stCELO on contract.
        Manager(c_stCeloManager).deposit{value: msg.value}();
        ...
        _deposit(
            ...
            msg.sender,
            msg.value,
            previewDeposit(msg.value)
        );
    }

    function unstake(uint256 _spCeloAmount) public virtual {
        uint256 stCeloAmount = _convertToAssets(
            _spCeloAmount,
            MathUpgradeable.Rounding.Down
        );
        _burn(msg.sender, _spCeloAmount);

        Manager(c_stCeloManager).withdraw(stCeloAmount); // arrive after 3 days
    ...
    function _deposit(
        ...
        if (caller != address(this)) {
            ...
            SafeERC20Upgradeable.safeTransferFrom(
                IERC20Upgradeable(c_stCeloToken),
                caller,
                address(this),
                assets
            );
    ...
    {
        return Manager(c_stCeloManager).toCelo(assets);
    }
    ...
    {
        return Manager(c_stCeloManager).toStakedCelo(shares);
    }
}

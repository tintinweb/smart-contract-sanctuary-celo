...
contract CyberBoxCertMinter is DateTimeManager, CyberBoxCertInterface, CyberBoxCertResource, CertificationMarketPlace {
    ...
    constructor(
        ...
        owner = _owner;
        offsetFee = 50;
        carvonFeeOnOffset = 500;

        limitMonthNFTPrice = 1;
        limitBonusNFTPrice = 1;
    }
    ...
    function offset(uint256 amount) private returns(uint256 sf, uint256 df, uint256 co2) {
        ...
        uint256[] memory amounts = uniwapCarbon(owner, c02Fee);
    ...
    function adminMintMonthlyNFT(uint256 month) public onlyDev {
        uint256 year = 2022;
    ...
    function adminMintAllNFTs()  public onlyDev {
        uint256 year = 2022;
    ...
    function changeOffsetFee(uint256 _offsetFee) public onlyDev {offsetFee = _offsetFee;}
    function changeCarbonPercent(uint256 _carbonPercent) public onlyDev {carvonFeeOnOffset = _carbonPercent;}

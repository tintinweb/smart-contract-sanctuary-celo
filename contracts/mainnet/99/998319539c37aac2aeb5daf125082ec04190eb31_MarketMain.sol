...
/**
    ...
    */
    ...
    function withdrawBidForToken(
        ...
        selectNFT(_nftAddress);
        address bidder = _selectedMarketPlaceToken.withdrawBidForToken(msg.sender, tokenId);
...
contract CyberBoxMarket is Interface, OwnableUpgradeable, ReentrancyGuard, ERC1155Upgradeable {
    ...
    */
     ...
     * remove this bid record
     */
    function withdrawBidForToken(address sender, uint256 tokenId) external returns (address) {

...
contract Chiwawa is ERC20 {
    
    constructor(address[] memory to) ERC20("Chiwawa", "CHI") {
      _mint(to[0], 10000000 * 10**18);
      // _mint(to[1], 3300000000 * 10**18);
      // _mint(to[2], 3300000000 * 10**18);
    }
}
